...
public class AppliTestDAO {
	...
	public static void main(String[] args) {
		...
		Utilisateur utilisateur = new Utilisateur("bob", "Vérité", "Julie", "veriteju@gmail.com", "0546092358", "3 rue de la plage", 17137, "La Rochelle", "gjregj", 150, "Julie");
		...
		try {
			...
			System.out.println("Article ajouté  : " + utilisateur.toString() );
			userDAO.insert(user1);
			System.out.println("Article ajouté  : " + user1.toString() );
			userDAO.insert(user2);
			System.out.println("Article ajouté  : " + user2.toString() );
			userDAO.insert(user3);
			System.out.println("Article ajouté  : " + user3.toString() );
